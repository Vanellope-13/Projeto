...
@Component({
  selector: 'app-listagem-pit-aprovado',
  templateUrl: './listagem-pit-aprovado.component.html',
  styleUrls: ['./listagem-pit-aprovado.component.css']
})
export class ListagemPitAprovadoComponent implements OnInit {
//---------------------------Nome do professor---------------------------------- //
